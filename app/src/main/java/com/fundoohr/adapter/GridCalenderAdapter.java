...
public class GridCalenderAdapter extends BaseAdapter {
    ...
    public GridCalenderAdapter(Context context, ArrayList<AttendenceModel> mAttendenceModels, int month, int year, Button save, Button cancel) {
        super();
        this.save = save;
        this.cancel = cancel;
        ...
        Debug.showLog("size is ",""+attendenceModels.size());
    ...
    public View getView(int position, View convertView, final ViewGroup parent) {
      ...
      //  AttendenceModel model = attendenceModels.get(position);
       ...
       /* if (!theday.equals(" ") && model.getAttendenceStatus().equalsIgnoreCase("Present")) {
        ...
        Debug.showLog("Size ","asd "+attendenceModels);
        ...
        if(attendenceModels!=null && attendenceModels.size()>0 && position < attendenceModels.size()  ){
            ...
            Log.i("adasd", "getView: "+Integer.parseInt(attendenceModels.get(position).getDays()));
            if( !attendenceModels.get(position).getDays().equalsIgnoreCase("null") && Integer.parseInt(attendenceModels.get(position).getDays()) == position+1)
                textMark.setImageResource(R.drawable.checkmark);
        }
        else{
            textMark.setImageResource(R.drawable.leave);
