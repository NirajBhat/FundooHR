...
import com.fundoohr.view.fragment.BankingDetailsFragment;
import com.fundoohr.view.fragment.HRDetailsFragment;
import com.fundoohr.view.fragment.PersonaldetailsFragment;
import com.fundoohr.view.fragment.ProfileDetailsFragment;
import com.fundoohr.view.fragment.TrackingDetailsFragment;
...
public class EngineerProfileActivity extends AppCompatActivity implements EnggViewModelInterface {
  ...
  /*  public void callAttendence(){
    ...
    public void callBanking() {
        ...
        getSupportFragmentManager().beginTransaction().replace(R.id.collapse_frame, bank,BankingDetailsFragment.TAG).addToBackStack(null).commit();
    }
